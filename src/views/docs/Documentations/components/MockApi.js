	...
	return (
		<>
			...
			<div className="mt-10" id="disableMockApi">
				...
				<p className="mt-1">
					Mock api was enabled by default in our starter-kit, you can turn in on via setting <code>enableMock</code> field to false in <code>src/configs/app.config.js</code> to turn off the mock api.
				</p>
